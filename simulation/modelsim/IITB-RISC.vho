...
-- c_en	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
\c_en~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
...
-- Equation(s):
-- \carry~0_combout\ = (\c_en~input_o\ & (\c_in~input_o\)) # (!\c_en~input_o\ & ((\carry~q\)))
